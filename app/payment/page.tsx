...
// // //                 type="button"
// // //                 onClick={decrement}
// // //                 className="w-8 h-8 rounded-md border border-gray-600 text-white hover:bg-gray-800"
...
// // //             {"You've registered"} {ticketCount} ticket
// // //             {ticketCount > 1 ? "s" : ""} for Startup Junction.
// // //           </p>
