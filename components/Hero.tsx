...
const Hero: FunctionComponent = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center items-center overflow-hidden py-2 px-4 sm:px-0">
      {/* Background */}
      ...
      >
        ...
        <div className="relative group">
          <div className="absolute -inset-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full blur-2xl opacity-20 group-hover:opacity-40 transition duration-1000" />
          <Image
            unoptimized
            src={Logo}
        ...
        <motion.p
          ...
          className="
            ...
            md:leading-loose md:font-normal font-light
            hidden md:block text-shadow-sm
          "
        >
            ...
            <Link href="/payment?type=StartupExpo">
              <button
                className="
                  ...
                  flex items-center justify-between gap-4 font-bold
                  transition-all duration-300 hover:scale-105
                  hover:bg-[#23C0AD]/10 hover:shadow-[0_0_30px_rgba(35,192,173,0.4)]
                  relative
                "
              >
                ...
                <ArrowRight className="relative z-10 w-5 h-5 text-[#23C0AD] group-hover:text-white transition-colors" />
              </button>
            </Link>
          </motion.div>
        </motion.div>
