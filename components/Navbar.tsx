                ...
                >
                  E‑Summit 26
                          ...
                          `}
                                    ...
                                    <li onMouseEnter={handleSJEnter} onMouseLeave={handleSJLeave} className="relative">
                          ...
                          "
                                                >
                                                    SJ
                                                    <ChevronDown size={14} className={`transition-transform ${isHoveringSJ ? "rotate-180" : ""}`} />
                                                </button>
                                            </DropdownMenuTrigger>
                        ...
                        "
                                            >
                                                <DropdownMenuLabel className="text-xs text-white/60">Startup Junction</DropdownMenuLabel>
                                                <DropdownMenuSeparator className="bg-white/15" />

                                                {sjCities.map((city) => (
                                                    <DropdownMenuItem key={city} className="cursor-pointer">
                                                        <Link href={`/SJ/${city}`} className="flex w-full items-center justify-between text-sm">
                                                            <span>SJ – {city.charAt(0).toUpperCase() + city.slice(1)}</span>
                                                            <ChevronDown size={13} className="rotate-[-90deg] text-white/40" />
                                                        </Link>
                                                    </DropdownMenuItem>
                                                ))}
                                            </DropdownMenuContent>
          ...
          `}
                >
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        <span className="text-xl uppercase tracking-[0.18em] text-white/50">Menu</span>
                    ...
                    <nav className="space-y-6">
                      ...
                      `}
                                        >
                                            <span className={isActive ? "text-white" : "text-white/80"}>{item.name}</span>
                        ...
                        <div className="pt-4 border-t border-white/10">
                            <p className="text-xs uppercase tracking-[0.18em] text-white/50 mb-2">Startup Junction</p>
            ...
            <ToastContainer />
            <Script src="https://www.townscript.com/static/Bookingflow/js/townscript-widget.nocache.js" strategy="afterInteractive" />
        </>
    );
};
